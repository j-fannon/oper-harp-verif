...
#' Average FSS rank into format for text box in plot
#'
#' @param verif_data[[fc_model]]
#' @return string for plotting
text_for_plot_fss_rank <- function(data_tbl,fss_str = "FSS", fss_var = "rank_avg_fss_rank"){
  print(data_tbl)
  paste0(fss_str," Rank: ",data_tbl[[fss_var]])
